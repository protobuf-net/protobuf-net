...
namespace ProtoBuf
{
    sealed class NullableSerializer<T> : ISerializer<Nullable<T>> where T : struct
    {
        ...
        public WireType WireType { get { return innerSerializer.WireType; } }
        public string DefinedType { get { return innerSerializer.DefinedType; } }
