...
// This file began as protogen output but has been hand-maintained since (renamed members, extra
// usings, added defaults), so it is NOT regenerated - see the diff against `protogen.proto`. The
// nullable annotations below are therefore hand-applied, but follow exactly what the generator
// would emit for each shape.
#nullable enable
using ProtoBuf.Meta;
