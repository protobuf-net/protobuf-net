...
// input sha256 0833e89357ed1a4c1e1d29571376a3d3d1644e718e368f38d860aeeff676fade
...
internal sealed class ___PBN_Services___ExoticModel : ISerializer<Exotics>
{
	Exotics ISerializer<Exotics>.Read(ref ProtoReader.State state, Exotics value)
	{
		...
		while ((num = state.ReadFieldHeader()) > 0)
		{
			...
			case 26:
			{
				LinkedList<int> linked = value.Linked;
				linked = RepeatedSerializer.CreateEnumerable<LinkedList<int>, int>().ReadRepeated(ref state, SerializerFeatures.WireTypeVarint | SerializerFeatures.OptionPackedDisabled, linked);
				if (linked != null)
				{
					value.Linked = linked;
				}
	...
	void ISerializer<Exotics>.Write(ref ProtoWriter.State state, Exotics value)
	{
		...
		if (linked != null)
		{
			LinkedList<int> values24 = linked;
			RepeatedSerializer.CreateEnumerable<LinkedList<int>, int>().WriteRepeated(ref state, 26, SerializerFeatures.WireTypeVarint | SerializerFeatures.OptionPackedDisabled, values24);
		}
	}
