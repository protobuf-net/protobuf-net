...
partial class ModelSurrogateModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.ModelSurrogate.DateTimeOffsetSurrogate>();
        RegisterRootType<global::AotFixtures.ModelSurrogate.Holder>();
        RegisterRootType<global::AotFixtures.ModelSurrogate.Ticks>();
        RegisterRootType<global::AotFixtures.ModelSurrogate.TicksSurrogate>();
        RegisterRootType<global::AotFixtures.ModelSurrogate.VersionSurrogate>();
        RegisterRootType<global::System.DateTimeOffset>();
        RegisterRootType<global::System.Version>();
    }
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::System.Version>
    {
        ...
        private static long Measure_AotFixtures_ModelSurrogate_DateTimeOffsetSurrogate(global::AotFixtures.ModelSurrogate.DateTimeOffsetSurrogate value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            ...
            short tmp_short;
            tmp_long = value.Ticks;
            if (tmp_long != 0) len += 1 + global::ProtoBuf.ProtoWriter.State.MeasureRawVarint64(unchecked((ulong)tmp_long));  // Ticks
            tmp_short = value.OffsetMinutes;
            if (tmp_short != 0) len += 1 + global::ProtoBuf.ProtoWriter.State.MeasureRawVarint64(unchecked((ulong)(long)tmp_short));  // OffsetMinutes
            return len;
        }
        ...
        public static void RawWrite_AotFixtures_ModelSurrogate_Holder(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.ModelSurrogate.Holder value, int depth)
        {
            ...
            global::System.DateTimeOffset tmp_System_DateTimeOffset;
            ...
            state.WriteRawVarint64((ulong)len);
            DebugCapturePosition(ref state, ref before);
            RawWrite_AotFixtures_ModelSurrogate_Ticks(ref state, tmp_AotFixtures_ModelSurrogate_Ticks, depth);
            ...
            state.WriteRawVarint64((ulong)len);
            DebugCapturePosition(ref state, ref before);
            RawWrite_System_DateTimeOffset(ref state, tmp_System_DateTimeOffset, depth);
        ...
        private static long Measure_AotFixtures_ModelSurrogate_Ticks(global::AotFixtures.ModelSurrogate.Ticks value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            ...
            long tmp_long;
            tmp_long = surrogate.Value;
            if (tmp_long != 0) len += 1 + global::ProtoBuf.ProtoWriter.State.MeasureRawVarint64(unchecked((ulong)tmp_long));  // Value
            return len;
        }
        ...
        public static void RawWrite_System_DateTimeOffset(ref global::ProtoBuf.ProtoWriter.State state, global::System.DateTimeOffset value, int depth)
        {
            ...
            long tmp_long;
            short tmp_short;
            tmp_long = surrogate.Ticks;
            if (tmp_long != 0)
            {
                state.WriteRawTag((1 << 3) | 0);  // Ticks
                state.WriteRawVarint64(unchecked((ulong)tmp_long));
            }
            tmp_short = surrogate.OffsetMinutes;
            if (tmp_short != 0)
            {
                state.WriteRawTag((2 << 3) | 0);  // OffsetMinutes
                state.WriteRawVarint64(unchecked((ulong)(long)tmp_short));
