...
partial class DynamicCategoryModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.DynamicCategory.Label>();
        RegisterRootType<global::AotFixtures.DynamicCategory.Measure>();
        RegisterRootType<global::AotFixtures.DynamicCategory.Reading>();
    }
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.DynamicCategory.Reading value, object userState = null)
    {
        ...
        try
        {
            ...
            GetSerializer<global::AotFixtures.DynamicCategory.Reading>().Write(ref state, value);
            state.Close();
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.DynamicCategory.Reading value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
