...
partial class SkipCtorModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.SkipCtor.Bypassed>();
        RegisterRootType<global::AotFixtures.SkipCtor.Constructed>();
    }
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.SkipCtor.Bypassed value, object userState = null)
    {
        ...
        try
        {
            ...
            GetSerializer<global::AotFixtures.SkipCtor.Bypassed>().Write(ref state, value);
            state.Close();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.SkipCtor.Constructed value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.SkipCtor.Constructed>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SkipCtor.Constructed>
    {
        ...
        private static long Measure_AotFixtures_SkipCtor_Bypassed(global::AotFixtures.SkipCtor.Bypassed value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SkipCtor.Bypassed>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.SkipCtor.Bypassed value)
        {
            ...
            var len = Measure_AotFixtures_SkipCtor_Bypassed(value, depth, slots, context);
        ...
        private static long Measure_AotFixtures_SkipCtor_Constructed(global::AotFixtures.SkipCtor.Constructed value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SkipCtor.Constructed>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.SkipCtor.Constructed value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_SkipCtor_Constructed(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
