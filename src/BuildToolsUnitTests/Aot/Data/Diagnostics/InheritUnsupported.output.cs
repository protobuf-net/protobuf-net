...
partial class InheritUnsupportedModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.InheritUnsupported.AbstractLeaf>();
        RegisterRootType<global::AotFixtures.InheritUnsupported.Unlinked>();
    }
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.InheritUnsupported.Unlinked>
    {
        ...
        private static long Measure_AotFixtures_InheritUnsupported_AbstractLeaf(global::AotFixtures.InheritUnsupported.AbstractLeaf value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.InheritUnsupported.AbstractLeaf>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.InheritUnsupported.AbstractLeaf value)
        {
            ...
            var len = Measure_AotFixtures_InheritUnsupported_AbstractLeaf(value, depth, slots, context);
        ...
        private static long Measure_AotFixtures_InheritUnsupported_Unlinked(global::AotFixtures.InheritUnsupported.Unlinked value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.InheritUnsupported.Unlinked>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.InheritUnsupported.Unlinked value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_InheritUnsupported_Unlinked(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
