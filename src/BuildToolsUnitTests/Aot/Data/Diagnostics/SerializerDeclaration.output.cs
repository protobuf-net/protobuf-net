...
partial class SerializerDeclarationModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.SerializerDeclaration.Untouched>();
    }
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.SerializerDeclaration.Untouched value, object userState = null)
    {
        ...
        try
        {
            ...
            GetSerializer<global::AotFixtures.SerializerDeclaration.Untouched>().Write(ref state, value);
            state.Close();
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.SerializerDeclaration.Untouched value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
        ...
        : global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SerializerDeclaration.Untouched>
    {
        ...
        private static long Measure_AotFixtures_SerializerDeclaration_Untouched(global::AotFixtures.SerializerDeclaration.Untouched value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            var tmp1 = value.Value;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SerializerDeclaration.Untouched>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.SerializerDeclaration.Untouched value)
        {
            ...
            var len = Measure_AotFixtures_SerializerDeclaration_Untouched(value, depth, slots, context);
