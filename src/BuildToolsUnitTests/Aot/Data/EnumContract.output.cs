...
partial class EnumContractModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.EnumContract.Holder>();
    }
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.EnumContract.Holder value, object userState = null)
    {
        ...
        try
        {
            ...
            GetSerializer<global::AotFixtures.EnumContract.Holder>().Write(ref state, value);
            state.Close();
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.EnumContract.Holder value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
        ...
        , global::ProtoBuf.Serializers.ISerializerProxy<global::AotFixtures.EnumContract.Size?>
    {
        ...
        private static long Measure_AotFixtures_EnumContract_Holder(global::AotFixtures.EnumContract.Holder value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            global::AotFixtures.EnumContract.Shade tmp_AotFixtures_EnumContract_Shade;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.EnumContract.Holder>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.EnumContract.Holder value)
        {
            ...
            var len = Measure_AotFixtures_EnumContract_Holder(value, depth, slots, context);
