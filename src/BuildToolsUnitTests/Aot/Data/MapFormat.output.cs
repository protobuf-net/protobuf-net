...
partial class MapFormatModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.MapFormat.Maps>();
        RegisterRootType<global::AotFixtures.MapFormat.Nested>();
    }
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.MapFormat.Maps value, object userState = null)
    {
        ...
        try
        {
            ...
            GetSerializer<global::AotFixtures.MapFormat.Maps>().Write(ref state, value);
            state.Close();
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.MapFormat.Maps value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.MapFormat.Nested value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.MapFormat.Nested>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.MapFormat.Nested value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.MapFormat.Nested>
    {
        ...
        void global::ProtoBuf.Serializers.ISerializer<global::AotFixtures.MapFormat.Nested>.Write(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.MapFormat.Nested value)
            => RawWrite_AotFixtures_MapFormat_Nested(ref state, value, state.RawDepthBudget);

        public static void RawWrite_AotFixtures_MapFormat_Nested(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.MapFormat.Nested value, int depth)
        {
        ...
        private static long Measure_AotFixtures_MapFormat_Nested(global::AotFixtures.MapFormat.Nested value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            var tmp1 = value.Id;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.MapFormat.Nested>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.MapFormat.Nested value)
        {
            ...
            var len = Measure_AotFixtures_MapFormat_Nested(value, depth, slots, context);
