...
partial class NonPublicCtorModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.NonPublicCtor.Holder>();
        RegisterRootType<global::AotFixtures.NonPublicCtor.InternalCtor>();
        RegisterRootType<global::AotFixtures.NonPublicCtor.PrivateCtor>();
        RegisterRootType<global::AotFixtures.NonPublicCtor.ProtectedCtor>();
    }
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.NonPublicCtor.Holder value, object userState = null)
    {
        ...
        try
        {
            ...
            GetSerializer<global::AotFixtures.NonPublicCtor.Holder>().Write(ref state, value);
            state.Close();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.NonPublicCtor.InternalCtor value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.NonPublicCtor.InternalCtor>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.NonPublicCtor.PrivateCtor value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.NonPublicCtor.PrivateCtor>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.NonPublicCtor.ProtectedCtor value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.NonPublicCtor.ProtectedCtor>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.NonPublicCtor.ProtectedCtor>
    {
        ...
        public static void RawWrite_AotFixtures_NonPublicCtor_Holder(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.NonPublicCtor.Holder value, int depth)
        {
            ...
            if (tmp_AotFixtures_NonPublicCtor_PrivateCtor != null)
            {
                ...
                RawWrite_AotFixtures_NonPublicCtor_PrivateCtor(ref state, tmp_AotFixtures_NonPublicCtor_PrivateCtor, depth);
                DebugAssertPosition(ref state, before + len, "Child");
            }
        }

        private static long Measure_AotFixtures_NonPublicCtor_Holder(global::AotFixtures.NonPublicCtor.Holder value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int slot;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.NonPublicCtor.Holder>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.NonPublicCtor.Holder value)
        {
            ...
            var len = Measure_AotFixtures_NonPublicCtor_Holder(value, depth, slots, context);
        ...
        private static long Measure_AotFixtures_NonPublicCtor_InternalCtor(global::AotFixtures.NonPublicCtor.InternalCtor value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.NonPublicCtor.InternalCtor>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.NonPublicCtor.InternalCtor value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_NonPublicCtor_InternalCtor(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
        ...
        private static long Measure_AotFixtures_NonPublicCtor_PrivateCtor(global::AotFixtures.NonPublicCtor.PrivateCtor value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.NonPublicCtor.PrivateCtor>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.NonPublicCtor.PrivateCtor value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_NonPublicCtor_PrivateCtor(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
        ...
        private static long Measure_AotFixtures_NonPublicCtor_ProtectedCtor(global::AotFixtures.NonPublicCtor.ProtectedCtor value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.NonPublicCtor.ProtectedCtor>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.NonPublicCtor.ProtectedCtor value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_NonPublicCtor_ProtectedCtor(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
