...
partial class PartialModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.Partial.Contested>();
        RegisterRootType<global::AotFixtures.Partial.Described>();
        RegisterRootType<global::AotFixtures.Partial.Excluded>();
        RegisterRootType<global::AotFixtures.Partial.Mixed>();
    }
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Partial.Contested value, object userState = null)
    {
        ...
        try
        {
            ...
            GetSerializer<global::AotFixtures.Partial.Contested>().Write(ref state, value);
            state.Close();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Partial.Described value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.Partial.Described>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Partial.Excluded value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.Partial.Excluded>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Partial.Mixed value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.Partial.Mixed>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Partial.Mixed>
    {
        ...
        private static long Measure_AotFixtures_Partial_Contested(global::AotFixtures.Partial.Contested value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Partial.Contested>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.Partial.Contested value)
        {
            ...
            var len = Measure_AotFixtures_Partial_Contested(value, depth, slots, context);
        ...
        private static long Measure_AotFixtures_Partial_Excluded(global::AotFixtures.Partial.Excluded value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Partial.Excluded>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.Partial.Excluded value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_Partial_Excluded(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
        ...
        private static long Measure_AotFixtures_Partial_Mixed(global::AotFixtures.Partial.Mixed value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Partial.Mixed>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.Partial.Mixed value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_Partial_Mixed(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
