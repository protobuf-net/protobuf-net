...
partial class SchemaOnlyModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.SchemaOnly.Empty>();
        RegisterRootType<global::AotFixtures.SchemaOnly.EmptyExtensible>();
        RegisterRootType<global::AotFixtures.SchemaOnly.Ignoring>();
        RegisterRootType<global::AotFixtures.SchemaOnly.Plain>();
        RegisterRootType<global::AotFixtures.SchemaOnly.SchemaOnly>();
    }
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.SchemaOnly.Empty value, object userState = null)
    {
        ...
        try
        {
            ...
            GetSerializer<global::AotFixtures.SchemaOnly.Empty>().Write(ref state, value);
            state.Close();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.SchemaOnly.EmptyExtensible value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.SchemaOnly.EmptyExtensible>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.SchemaOnly.Ignoring value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.SchemaOnly.Ignoring>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.SchemaOnly.Plain value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.SchemaOnly.Plain>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.SchemaOnly.SchemaOnly value, object userState = null)
    {
        ...
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.SchemaOnly.SchemaOnly>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SchemaOnly.SchemaOnly>
    {
        ...
        private static long Measure_AotFixtures_SchemaOnly_Empty(global::AotFixtures.SchemaOnly.Empty value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            return len;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SchemaOnly.Empty>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.SchemaOnly.Empty value)
        {
            ...
            var len = Measure_AotFixtures_SchemaOnly_Empty(value, depth, slots, context);
        ...
        private static long Measure_AotFixtures_SchemaOnly_EmptyExtensible(global::AotFixtures.SchemaOnly.EmptyExtensible value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SchemaOnly.EmptyExtensible>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.SchemaOnly.EmptyExtensible value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_SchemaOnly_EmptyExtensible(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
        ...
        private static long Measure_AotFixtures_SchemaOnly_Ignoring(global::AotFixtures.SchemaOnly.Ignoring value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SchemaOnly.Ignoring>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.SchemaOnly.Ignoring value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_SchemaOnly_Ignoring(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
        ...
        private static long Measure_AotFixtures_SchemaOnly_Plain(global::AotFixtures.SchemaOnly.Plain value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SchemaOnly.Plain>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.SchemaOnly.Plain value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_SchemaOnly_Plain(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
        ...
        private static long Measure_AotFixtures_SchemaOnly_SchemaOnly(global::AotFixtures.SchemaOnly.SchemaOnly value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.SchemaOnly.SchemaOnly>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.SchemaOnly.SchemaOnly value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_SchemaOnly_SchemaOnly(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
