...
partial class BclLevel300Model
{
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.BclLevel300.Level300 value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
            return state.SerializeRoot<global::AotFixtures.BclLevel300.Level300>(value, GetSerializer<global::AotFixtures.BclLevel300.Level300>());
        }
        finally
        {
            state.Dispose();
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.BclLevel300.Level300 value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
        ...
        : global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.BclLevel300.Level300>
    {
        ...
        private static long Measure_AotFixtures_BclLevel300_Level300(global::AotFixtures.BclLevel300.Level300 value, int depth, global::ProtoBuf.RawLengthBuffer slots)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            var tmp1 = value.AsString;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.BclLevel300.Level300>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.BclLevel300.Level300 value)
        {
            ...
            var len = Measure_AotFixtures_BclLevel300_Level300(value, depth, slots);
