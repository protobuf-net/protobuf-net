...
partial class ExtensibleModel
{
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Extensible.BaseExt value, object userState = null)
    {
        ...
        try
        {
            return state.SerializeRoot<global::AotFixtures.Extensible.BaseExt>(value, GetSerializer<global::AotFixtures.Extensible.BaseExt>());
        }
        finally
        {
            state.Dispose();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Extensible.ByHand value, object userState = null)
    {
        ...
        try
        {
            return state.SerializeRoot<global::AotFixtures.Extensible.ByHand>(value, GetSerializer<global::AotFixtures.Extensible.ByHand>());
        }
        finally
        {
            state.Dispose();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Extensible.DerivedExt value, object userState = null)
    {
        ...
        try
        {
            return state.SerializeRoot<global::AotFixtures.Extensible.DerivedExt>(value, GetSerializer<global::AotFixtures.Extensible.DerivedExt>());
        }
        finally
        {
            state.Dispose();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Extensible.FromBase value, object userState = null)
    {
        ...
        try
        {
            return state.SerializeRoot<global::AotFixtures.Extensible.FromBase>(value, GetSerializer<global::AotFixtures.Extensible.FromBase>());
        }
        finally
        {
            state.Dispose();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Extensible.TypedOnly value, object userState = null)
    {
        ...
        try
        {
            return state.SerializeRoot<global::AotFixtures.Extensible.TypedOnly>(value, GetSerializer<global::AotFixtures.Extensible.TypedOnly>());
        }
        finally
        {
            state.Dispose();
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Extensible.TypedOnly>
    {
        ...
        private static long Measure_AotFixtures_Extensible_ByHand(global::AotFixtures.Extensible.ByHand value, int depth, global::ProtoBuf.RawLengthBuffer slots)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            var tmp1 = value.Value;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Extensible.ByHand>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.Extensible.ByHand value)
        {
            ...
            var len = Measure_AotFixtures_Extensible_ByHand(value, depth, slots);
        ...
        private static long Measure_AotFixtures_Extensible_FromBase(global::AotFixtures.Extensible.FromBase value, int depth, global::ProtoBuf.RawLengthBuffer slots)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            var tmp1 = value.Value;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Extensible.FromBase>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.Extensible.FromBase value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_Extensible_FromBase(value, depth, slots);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
        ...
        private static long Measure_AotFixtures_Extensible_TypedOnly(global::AotFixtures.Extensible.TypedOnly value, int depth, global::ProtoBuf.RawLengthBuffer slots)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            var tmp1 = value.Value;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Extensible.TypedOnly>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.Extensible.TypedOnly value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_Extensible_TypedOnly(value, depth, slots);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
