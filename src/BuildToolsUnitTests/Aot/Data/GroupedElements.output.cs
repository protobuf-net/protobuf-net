...
partial class GroupedElementsModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.GroupedElements.Grouped>();
        RegisterRootType<global::AotFixtures.GroupedElements.GroupedMaps>();
        RegisterRootType<global::AotFixtures.GroupedElements.GroupedOnly>();
        RegisterRootType<global::AotFixtures.GroupedElements.Item>();
        RegisterRootType<global::AotFixtures.GroupedElements.Node>();
    }
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.GroupedElements.Grouped value, object userState = null)
    {
        ...
        try
        {
            ...
            GetSerializer<global::AotFixtures.GroupedElements.Grouped>().Write(ref state, value);
            state.Close();
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.GroupedElements.Grouped value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.GroupedElements.GroupedMaps value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.GroupedElements.GroupedMaps>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.GroupedElements.GroupedMaps value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.GroupedElements.GroupedOnly value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.GroupedElements.GroupedOnly>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.GroupedElements.GroupedOnly value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.GroupedElements.Item value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.GroupedElements.Item>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.GroupedElements.Item value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.GroupedElements.Node value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.GroupedElements.Node>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.GroupedElements.Node value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.GroupedElements.Node>
    {
        ...
        public static void RawWrite_AotFixtures_GroupedElements_Grouped(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.GroupedElements.Grouped value, int depth)
        {
            ...
            global::AotFixtures.GroupedElements.Item tmp_AotFixtures_GroupedElements_Item;
            tmp_System_Collections_Generic_List_global__AotFixtures_GroupedElements_Item_ = value.Items;
            if (tmp_System_Collections_Generic_List_global__AotFixtures_GroupedElements_Item_ != null)
            {
                foreach (var item1 in global::System.Runtime.InteropServices.CollectionsMarshal.AsSpan(tmp_System_Collections_Generic_List_global__AotFixtures_GroupedElements_Item_))
                {
            ...
            tmp_AotFixtures_GroupedElements_Item__ = value.Array;
            if (tmp_AotFixtures_GroupedElements_Item__ != null)
            {
                foreach (var item2 in tmp_AotFixtures_GroupedElements_Item__)
                {
            ...
            tmp_System_Collections_Generic_List_global__AotFixtures_GroupedElements_Item_ = value.Plain;
            if (tmp_System_Collections_Generic_List_global__AotFixtures_GroupedElements_Item_ != null)
            {
            ...
            tmp_AotFixtures_GroupedElements_Item = value.Single;
            if (tmp_AotFixtures_GroupedElements_Item != null)
            {
                state.WriteRawTag((5 << 3) | 3);  // Single (start group)
                RawWrite_AotFixtures_GroupedElements_Item(ref state, tmp_AotFixtures_GroupedElements_Item, depth);
                state.WriteRawTag((5 << 3) | 4);  // Single (end group)
            }
        }

        private static long Measure_AotFixtures_GroupedElements_Grouped(global::AotFixtures.GroupedElements.Grouped value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int slot;
            ...
            if (tmp_System_Collections_Generic_List_global__AotFixtures_GroupedElements_Item_ != null)
            {
                ...
                {
                    if (item1 is null) global::ProtoBuf.ProtoWriter.State.ThrowNullRepeatedContents<global::AotFixtures.GroupedElements.Item>();
                    sub = Measure_AotFixtures_GroupedElements_Item(item1, depth, slots, context);
                    len += 2 + sub;
                }
            }
            tmp_AotFixtures_GroupedElements_Item__ = value.Array;
            if (tmp_AotFixtures_GroupedElements_Item__ != null)
            {
                ...
                {
                    if (item2 is null) global::ProtoBuf.ProtoWriter.State.ThrowNullRepeatedContents<global::AotFixtures.GroupedElements.Item>();
                    sub = Measure_AotFixtures_GroupedElements_Item(item2, depth, slots, context);
                    len += 2 + sub;
                }
            }
            tmp_System_Collections_Generic_List_global__AotFixtures_GroupedElements_Item_ = value.Plain;
            ...
            if (tmp_AotFixtures_GroupedElements_Item != null)
            {
                sub = Measure_AotFixtures_GroupedElements_Item(tmp_AotFixtures_GroupedElements_Item, depth, slots, context);
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.GroupedElements.Grouped>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.GroupedElements.Grouped value)
        {
            ...
            var len = Measure_AotFixtures_GroupedElements_Grouped(value, depth, slots, context);
        ...
        {
            global::ProtoBuf.Meta.TypeModel.ThrowUnexpectedSubtype(value);
            global::System.Collections.Generic.Dictionary<int, global::AotFixtures.GroupedElements.Item> tmp_System_Collections_Generic_Dictionary_int__global__AotFixtures_GroupedElements_Item_;
            global::System.Collections.Generic.Dictionary<string, string> tmp_System_Collections_Generic_Dictionary_string__string_;
            tmp_System_Collections_Generic_Dictionary_int__global__AotFixtures_GroupedElements_Item_ = value.ByIndex;
            if (tmp_System_Collections_Generic_Dictionary_int__global__AotFixtures_GroupedElements_Item_ != null)
            {
                global::ProtoBuf.Serializers.MapSerializer.CreateDictionary<int, global::AotFixtures.GroupedElements.Item>().WriteMap(ref state, 1, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeStartGroup | global::ProtoBuf.Serializers.SerializerFeatures.OptionPackedDisabled, tmp_System_Collections_Generic_Dictionary_int__global__AotFixtures_GroupedElements_Item_, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeVarint, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeString, null, this);
            }
            tmp_System_Collections_Generic_Dictionary_string__string_ = value.Scalars;
            if (tmp_System_Collections_Generic_Dictionary_string__string_ != null)
            {
                global::ProtoBuf.Serializers.MapSerializer.CreateDictionary<string, string>().WriteMap(ref state, 2, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeStartGroup | global::ProtoBuf.Serializers.SerializerFeatures.OptionPackedDisabled, tmp_System_Collections_Generic_Dictionary_string__string_, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeString, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeString);
            }
            tmp_System_Collections_Generic_Dictionary_int__global__AotFixtures_GroupedElements_Item_ = value.ViaMap;
            if (tmp_System_Collections_Generic_Dictionary_int__global__AotFixtures_GroupedElements_Item_ != null)
            {
                global::ProtoBuf.Serializers.MapSerializer.CreateDictionary<int, global::AotFixtures.GroupedElements.Item>().WriteMap(ref state, 3, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeString | global::ProtoBuf.Serializers.SerializerFeatures.OptionPackedDisabled, tmp_System_Collections_Generic_Dictionary_int__global__AotFixtures_GroupedElements_Item_, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeVarint, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeStartGroup, null, this);
            }
            tmp_System_Collections_Generic_Dictionary_int__global__AotFixtures_GroupedElements_Item_ = value.Plain;
            if (tmp_System_Collections_Generic_Dictionary_int__global__AotFixtures_GroupedElements_Item_ != null)
            {
                global::ProtoBuf.Serializers.MapSerializer.CreateDictionary<int, global::AotFixtures.GroupedElements.Item>().WriteMap(ref state, 4, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeString | global::ProtoBuf.Serializers.SerializerFeatures.OptionPackedDisabled, tmp_System_Collections_Generic_Dictionary_int__global__AotFixtures_GroupedElements_Item_, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeVarint, global::ProtoBuf.Serializers.SerializerFeatures.WireTypeString, null, this);
            }
        }
        ...
        global::ProtoBuf.Serializers.SerializerFeatures global::ProtoBuf.Serializers.ISerializer<global::AotFixtures.GroupedElements.GroupedOnly>.Features
            => global::ProtoBuf.Serializers.SerializerFeatures.CategoryMessage | global::ProtoBuf.Serializers.SerializerFeatures.WireTypeString | global::ProtoBuf.Serializers.SerializerFeatures.OptionTrySkipWritingWhenMeasuring;

        global::AotFixtures.GroupedElements.GroupedOnly global::ProtoBuf.Serializers.ISerializer<global::AotFixtures.GroupedElements.GroupedOnly>.Read(ref global::ProtoBuf.ProtoReader.State state, global::AotFixtures.GroupedElements.GroupedOnly value)
            => RawRead_AotFixtures_GroupedElements_GroupedOnly(ref state, value);

        void global::ProtoBuf.Serializers.ISerializer<global::AotFixtures.GroupedElements.GroupedOnly>.Write(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.GroupedElements.GroupedOnly value)
            => RawWrite_AotFixtures_GroupedElements_GroupedOnly(ref state, value, state.RawDepthBudget);

        public static void RawWrite_AotFixtures_GroupedElements_GroupedOnly(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.GroupedElements.GroupedOnly value, int depth)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            global::ProtoBuf.Meta.TypeModel.ThrowUnexpectedSubtype(value);
            int tmp_int;
            ...
            tmp_AotFixtures_GroupedElements_Item = value.Body;
            if (tmp_AotFixtures_GroupedElements_Item != null)
            {
                state.WriteRawTag((2 << 3) | 3);  // Body (start group)
                RawWrite_AotFixtures_GroupedElements_Item(ref state, tmp_AotFixtures_GroupedElements_Item, depth);
                state.WriteRawTag((2 << 3) | 4);  // Body (end group)
            }
            tmp_string = value.Trailer;
            if (tmp_string != null)
            {
                state.WriteRawTag((3 << 3) | 2);  // Trailer
                state.WriteRawString(tmp_string);
            }
        }

        private static long Measure_AotFixtures_GroupedElements_GroupedOnly(global::AotFixtures.GroupedElements.GroupedOnly value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
            ...
            if (tmp_AotFixtures_GroupedElements_Item != null)
            {
                var sub = Measure_AotFixtures_GroupedElements_Item(tmp_AotFixtures_GroupedElements_Item, depth, slots, context);
                len += 2 + sub;  // Body (group: no length prefix)
            }
            tmp_string = value.Trailer;
            if (tmp_string != null)
            {
                len += 1 + global::ProtoBuf.ProtoWriter.State.MeasureRawString(tmp_string);  // Trailer
            }
            return len;
        }

        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.GroupedElements.GroupedOnly>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.GroupedElements.GroupedOnly value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_GroupedElements_GroupedOnly(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }

        private static global::AotFixtures.GroupedElements.GroupedOnly RawRead_AotFixtures_GroupedElements_GroupedOnly(ref global::ProtoBuf.ProtoReader.State state, global::AotFixtures.GroupedElements.GroupedOnly value)
        {
            value ??= new global::AotFixtures.GroupedElements.GroupedOnly();
            uint tag = state.ReadRawTag();
            while (tag != 0)
            {
                switch (tag)
                {
                    ...
                    case (1 << 3) | 1:  // Id, field 1, fixed64
                        ...
                        break;
                    case (2 << 3) | 2:  // Body, field 2, length-prefixed
                    case (2 << 3) | 3:  // Body, field 2, group
                    {
                        var scope = state.PushScope(tag);
                        value.Body = RawRead_AotFixtures_GroupedElements_Item(ref state, value.Body);
                        state.PopScope(scope);
                        break;
                    }
                    case (3 << 3) | 2:  // Trailer, field 3, length-prefixed
                    {
                        var tmp3 = state.ReadRawString();
                        if (tmp3 != null) value.Trailer = tmp3;
                        break;
                    }
                    default:
                        if (state.IsScopeEnd(tag)) return value;
        ...
        void global::ProtoBuf.Serializers.ISerializer<global::AotFixtures.GroupedElements.Item>.Write(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.GroupedElements.Item value)
            => RawWrite_AotFixtures_GroupedElements_Item(ref state, value, state.RawDepthBudget);

        public static void RawWrite_AotFixtures_GroupedElements_Item(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.GroupedElements.Item value, int depth)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            global::ProtoBuf.Meta.TypeModel.ThrowUnexpectedSubtype(value);
            string tmp_string;
        ...
        private static long Measure_AotFixtures_GroupedElements_Item(global::AotFixtures.GroupedElements.Item value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            string tmp_string;
            ...
            tmp_int = value.Count;
            if (tmp_int != 0) len += 1 + global::ProtoBuf.ProtoWriter.State.MeasureRawVarint64(unchecked((ulong)(long)tmp_int));  // Count
            return len;
        }
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.GroupedElements.Item>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.GroupedElements.Item value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_GroupedElements_Item(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
        ...
        global::AotFixtures.GroupedElements.Node global::ProtoBuf.Serializers.ISerializer<global::AotFixtures.GroupedElements.Node>.Read(ref global::ProtoBuf.ProtoReader.State state, global::AotFixtures.GroupedElements.Node value)
            => RawRead_AotFixtures_GroupedElements_Node(ref state, value);

        void global::ProtoBuf.Serializers.ISerializer<global::AotFixtures.GroupedElements.Node>.Write(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.GroupedElements.Node value)
            => RawWrite_AotFixtures_GroupedElements_Node(ref state, value, state.RawDepthBudget);

        public static void RawWrite_AotFixtures_GroupedElements_Node(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.GroupedElements.Node value, int depth)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            global::ProtoBuf.Meta.TypeModel.ThrowUnexpectedSubtype(value);
            int tmp_int;
            global::AotFixtures.GroupedElements.Node tmp_AotFixtures_GroupedElements_Node;
            tmp_int = value.Id;
            if (tmp_int != 0)
            {
                state.WriteRawTag((1 << 3) | 0);  // Id
            ...
            tmp_AotFixtures_GroupedElements_Node = value.GroupTail;
            if (tmp_AotFixtures_GroupedElements_Node != null)
            {
                state.WriteRawTag((2 << 3) | 3);  // GroupTail (start group)
                RawWrite_AotFixtures_GroupedElements_Node(ref state, tmp_AotFixtures_GroupedElements_Node, depth);
                state.WriteRawTag((2 << 3) | 4);  // GroupTail (end group)
            }
        }

        private static long Measure_AotFixtures_GroupedElements_Node(global::AotFixtures.GroupedElements.Node value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
            ...
            if (tmp_AotFixtures_GroupedElements_Node != null)
            {
                var sub = Measure_AotFixtures_GroupedElements_Node(tmp_AotFixtures_GroupedElements_Node, depth, slots, context);
                len += 2 + sub;  // GroupTail (group: no length prefix)
            }
            return len;
        }

        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.GroupedElements.Node>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.GroupedElements.Node value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_GroupedElements_Node(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }

        private static global::AotFixtures.GroupedElements.Node RawRead_AotFixtures_GroupedElements_Node(ref global::ProtoBuf.ProtoReader.State state, global::AotFixtures.GroupedElements.Node value)
        {
            value ??= new global::AotFixtures.GroupedElements.Node();
            uint tag = state.ReadRawTag();
            while (tag != 0)
            {
                switch (tag)
                {
                    ...
                    case (1 << 3) | 1:  // Id, field 1, fixed64
                        value.Id = checked((int)unchecked((long)state.ReadRawFixed64()));
                        break;
                    case (2 << 3) | 2:  // GroupTail, field 2, length-prefixed
                    case (2 << 3) | 3:  // GroupTail, field 2, group
                    {
                        var scope = state.PushScope(tag);
                        value.GroupTail = RawRead_AotFixtures_GroupedElements_Node(ref state, value.GroupTail);
                        state.PopScope(scope);
                        break;
                    }
                    default:
