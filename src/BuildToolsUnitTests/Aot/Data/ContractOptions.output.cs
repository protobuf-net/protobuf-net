...
partial class ContractOptionsModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.ContractOptions.BothFamilies>();
        RegisterRootType<global::AotFixtures.ContractOptions.Grouped>();
        RegisterRootType<global::AotFixtures.ContractOptions.Lenient>();
        RegisterRootType<global::AotFixtures.ContractOptions.LenientBase>();
        RegisterRootType<global::AotFixtures.ContractOptions.LenientDerived>();
        RegisterRootType<global::AotFixtures.ContractOptions.ProtoOnly>();
    }
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.ContractOptions.ProtoOnly>
    {
        ...
        private static long Measure_AotFixtures_ContractOptions_BothFamilies(global::AotFixtures.ContractOptions.BothFamilies value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
            tmp_int = value.Ordered;
            if (tmp_int != 0) len += 1 + global::ProtoBuf.ProtoWriter.State.MeasureRawVarint64(unchecked((ulong)(long)tmp_int));  // Ordered
            tmp_int = value.Tagged;
            if (tmp_int != 0) len += 1 + global::ProtoBuf.ProtoWriter.State.MeasureRawVarint64(unchecked((ulong)(long)tmp_int));  // Tagged
            return len;
        }
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.ContractOptions.BothFamilies>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.ContractOptions.BothFamilies value)
        {
            ...
            var len = Measure_AotFixtures_ContractOptions_BothFamilies(value, depth, slots, context);
        ...
        private static long Measure_AotFixtures_ContractOptions_Grouped(global::AotFixtures.ContractOptions.Grouped value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.ContractOptions.Grouped>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.ContractOptions.Grouped value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_ContractOptions_Grouped(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
        ...
        private static long Measure_AotFixtures_ContractOptions_Lenient(global::AotFixtures.ContractOptions.Lenient value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.ContractOptions.Lenient>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.ContractOptions.Lenient value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_ContractOptions_Lenient(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
        ...
        private static long MeasureSub_AotFixtures_ContractOptions_LenientDerived(global::AotFixtures.ContractOptions.LenientDerived value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            ...
            if (tmp_string != null)
            {
                len += 1 + global::ProtoBuf.ProtoWriter.State.MeasureRawString(tmp_string);  // Extra
            }
            return len;
        }
        ...
        private static long Measure_AotFixtures_ContractOptions_ProtoOnly(global::AotFixtures.ContractOptions.ProtoOnly value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.ContractOptions.ProtoOnly>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.ContractOptions.ProtoOnly value)
        {
            if (!global::ProtoBuf.ProtoWriter.State.TryMeasureRawSlots(context, out var depth, out var slots)) return -1;
            var entry = slots.Mark();
            var len = Measure_AotFixtures_ContractOptions_ProtoOnly(value, depth, slots, context);
            slots.Enter(value, entry);
            return len <= int.MaxValue ? (int)len : -1;
        }
