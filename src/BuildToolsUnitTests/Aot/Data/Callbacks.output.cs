...
partial class CallbacksModel
{
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Callbacks.AfterOnly value, object userState = null)
    {
        ...
        try
        {
            return state.SerializeRoot<global::AotFixtures.Callbacks.AfterOnly>(value, GetSerializer<global::AotFixtures.Callbacks.AfterOnly>());
        }
        finally
        {
            state.Dispose();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Callbacks.Hooked value, object userState = null)
    {
        ...
        try
        {
            return state.SerializeRoot<global::AotFixtures.Callbacks.Hooked>(value, GetSerializer<global::AotFixtures.Callbacks.Hooked>());
        }
        finally
        {
            state.Dispose();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Callbacks.Standard value, object userState = null)
    {
        ...
        try
        {
            return state.SerializeRoot<global::AotFixtures.Callbacks.Standard>(value, GetSerializer<global::AotFixtures.Callbacks.Standard>());
        }
        finally
        {
            state.Dispose();
