...
partial class FormatsModel
{
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Formats.Formatted value, object userState = null)
    {
        ...
        try
        {
            return state.SerializeRoot<global::AotFixtures.Formats.Formatted>(value, GetSerializer<global::AotFixtures.Formats.Formatted>());
        }
        finally
        {
            state.Dispose();
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Formats.Inner value, object userState = null)
    {
        ...
        try
        {
            return state.SerializeRoot<global::AotFixtures.Formats.Inner>(value, GetSerializer<global::AotFixtures.Formats.Inner>());
        }
        finally
        {
            state.Dispose();
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Formats.Inner>
    {
        ...
        void global::ProtoBuf.Serializers.ISerializer<global::AotFixtures.Formats.Formatted>.Write(ref global::ProtoBuf.ProtoWriter.State state, global::AotFixtures.Formats.Formatted value)
        {
            ...
            if (tmp9 != null)
            {
                ...
                var len = Measure_AotFixtures_Formats_Inner(tmp9, state.RawDepthBudget, state.RawSlots);
        ...
        private static long Measure_AotFixtures_Formats_Inner(global::AotFixtures.Formats.Inner value, int depth, global::ProtoBuf.RawLengthBuffer slots)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            var tmp1 = value.Value;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Formats.Inner>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.Formats.Inner value)
        {
            ...
            var len = Measure_AotFixtures_Formats_Inner(value, depth, slots);
