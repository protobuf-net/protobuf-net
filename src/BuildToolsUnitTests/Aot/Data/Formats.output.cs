...
partial class FormatsModel
{
    ...
    {
        RegisterRootType<global::AotFixtures.Formats.Formatted>();
        RegisterRootType<global::AotFixtures.Formats.Inner>();
        RegisterRootType<global::AotFixtures.Formats.Sized>();
        RegisterRootType<global::AotFixtures.Formats.SizedHolder>();
    }
    ...
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Formats.Formatted value, object userState = null)
    {
        ...
        try
        {
            ...
            GetSerializer<global::AotFixtures.Formats.Formatted>().Write(ref state, value);
            state.Close();
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.Formats.Formatted value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.IO.Stream destination, global::AotFixtures.Formats.Inner value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
            if (value is null) return 0;
            long before = state.Position64;
            GetSerializer<global::AotFixtures.Formats.Inner>().Write(ref state, value);
            state.Close();
            return state.Position64 - before;
        }
        catch
    ...
    /// <summary>Serializes the supplied value.</summary>
    /// <remarks>Prefer this to the generic <c>Serialize&lt;T&gt;</c>: it resolves the serializer at compile time rather than per call.</remarks>
    public long Serialize(global::System.Buffers.IBufferWriter<byte> destination, global::AotFixtures.Formats.Inner value, object userState = null)
    {
        var state = global::ProtoBuf.ProtoWriter.State.Create(destination, this, userState);
        try
        {
        ...
        , global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Formats.SizedHolder>
    {
        ...
        private static long Measure_AotFixtures_Formats_Inner(global::AotFixtures.Formats.Inner value, int depth, global::ProtoBuf.RawLengthBuffer slots, global::ProtoBuf.ISerializationContext context)
        {
            if (--depth < 0) global::ProtoBuf.ProtoWriter.State.ThrowRawTooDeep();
            long len = 0;
            int tmp_int;
        ...
        int global::ProtoBuf.Serializers.IMeasuringSerializer<global::AotFixtures.Formats.Inner>.Measure(global::ProtoBuf.ISerializationContext context, global::ProtoBuf.WireType wireType, global::AotFixtures.Formats.Inner value)
        {
            ...
            var len = Measure_AotFixtures_Formats_Inner(value, depth, slots, context);
