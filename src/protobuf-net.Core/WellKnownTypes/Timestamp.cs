...
namespace ProtoBuf.WellKnownTypes
{
    ...
    partial class WellKnownSerializer : IBasicSerializer<Timestamp>, IBasicDeserializer<Timestamp>
    {
        Timestamp IBasicDeserializer<Timestamp>.Deserialize(ProtoReader reader, ref ProtoReader.State state, Timestamp value)
        {
        ...
        void IBasicSerializer<Timestamp>.Serialize(ProtoWriter writer, ref ProtoWriter.State state, Timestamp value)
