...
namespace ProtoBuf.WellKnownTypes
{
    partial class WellKnownSerializer : IProtoSerializer<decimal>, IProtoDeserializer<decimal>
    {
        ...
        decimal IProtoDeserializer<decimal>.Deserialize(ProtoReader reader, ref ProtoReader.State state, decimal value)
        {
            ulong low = 0;
            uint high = 0;
            uint signScale = 0;
        ...
        void IProtoSerializer<decimal>.Serialize(ProtoWriter writer, ref ProtoWriter.State state, decimal value)
        {
            ulong low;
            uint high, signScale;
