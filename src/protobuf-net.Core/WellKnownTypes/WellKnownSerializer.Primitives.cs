...
namespace ProtoBuf.WellKnownTypes
{
...

    {
        ...
        WireType ISerializer<string>.DefaultWireType => WireType.String;
        ...
        WireType ISerializer<int>.DefaultWireType => WireType.Varint;
        ...
        WireType ISerializer<byte[]>.DefaultWireType => WireType.String;
        ...
        WireType ISerializer<byte>.DefaultWireType => WireType.Varint;
        ...
        WireType ISerializer<ushort>.DefaultWireType => WireType.Varint;
        ...
        WireType ISerializer<uint>.DefaultWireType => WireType.Varint;
        ...
        WireType ISerializer<ulong>.DefaultWireType => WireType.Varint;
        ...
        WireType ISerializer<long>.DefaultWireType => WireType.Varint;
        ...
        WireType ISerializer<bool>.DefaultWireType => WireType.Varint;
        ...
        WireType ISerializer<float>.DefaultWireType => WireType.Fixed32;
        ...
        WireType ISerializer<double>.DefaultWireType => WireType.Fixed64;
        ...
        WireType ISerializer<sbyte>.DefaultWireType => WireType.Varint;
        ...
        WireType ISerializer<short>.DefaultWireType => WireType.Varint;
        ...
        WireType ISerializer<Uri>.DefaultWireType => WireType.String;
        ...
        WireType ISerializer<char>.DefaultWireType => WireType.Varint;
    }
}
