...
namespace ProtoBuf
{
    partial class ProtoWriter
    {
        ...
        {
            // ---- the raw write surface (notes/nano-writer.md) ----
            //
            ...
            // ---- the raw measure surface (notes/nano-writer.md, the measure-first cut) ----
            //
            ...
            /// <summary>
            /// The measure pass's length cache (notes/nano-writer.md, the <c>??=</c> design):
