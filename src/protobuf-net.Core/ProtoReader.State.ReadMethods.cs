...
#pragma warning restore IDE0060
            ...
            internal bool ContinuePackedScalar(long end, WireType elementWireType)
            {
                ...
                // v4 keeps the header state on the struct, so this re-arms _wireType directly
                // where main's class-backed reader went through _reader
                _wireType = elementWireType;
                return true;
            }
