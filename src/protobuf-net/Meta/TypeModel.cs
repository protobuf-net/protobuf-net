...
namespace ProtoBuf.Meta
{
    ...
    public abstract class TypeModel
    {
        ...
        /// either the original instance was null, or the stream defines a known sub-type of the
        /// original instance.</returns>
        public object DeserializeWithLengthPrefix(Stream source, object value, Type type, PrefixStyle style, int fieldNumber, SerializationContext serializationContext)
            => DeserializeWithLengthPrefix(source, value, type, style, fieldNumber, null, out long bytesRead, out var _, serializationContext);
