...
| mode | `proto` only | + `json` | + compression | + GET |
| --- | --- | --- | --- | --- |
| **server** | 207 / 207 | 390 / 390 | 1488 / 1488 | **1492 / 1492** |
| **client** | 253 / 253 | 444 / 444 | 1696 / 1696 | **1700 / 1700** |
...
counted: `zstd`, `snappy`, and TLS. Those are
...
- **TLS client certificates**, `zstd`, `snappy`.
